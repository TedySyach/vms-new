...
class Ion_auth_model extends CI_Model
{
	...
	public function registerCtm($email, $additional_data = array())
	{
		$this->trigger_events('pre_register');
		...
		$ip_address = $this->_prepare_ip($this->input->ip_address());
		$salt = $this->store_salt ? $this->salt() : FALSE;
		$password = $this->hash_password('tahu1234', $salt);
	...
	public function get_all_users()
  {
    ...
    return $this->db->get('users');
  	...
  	// additional get data user customer
	public function get_all_usersCtm()
  {
		$this->db->join('users_group', 'users.usertype = users_group.id_group');
		$this->db->where_not_in('usertype', array(1, 2));
    return $this->db->get('users');
  }

			...
			<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    <li class="breadcrumb-item"><a href="<?php echo base_url() ?>"><i class="fa fa-home"></i> Home</a></li>
					<li class="breadcrumb-item active">Selesaikan Transaksi Anda Sebelum: </li>
			  </ol>
			</nav>
    </div>

   <div class="col-lg-12"><h1 id="countdown">Waktu tersisa: 3:00</h1><hr>
...
function updateCountdown() {
    ...
    document.getElementById('countdown').innerText = 'Waktu Tersisa Untuk Menyelesaikan Transaksi Anda: ' + minutes + ':' + (seconds < 10 ? '0' : '') + seconds;

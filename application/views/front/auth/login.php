			...
			<div class="row">
			  <div class="col-lg-12">
					...
					<?php echo form_open("auth/login");?>
						...
						<?php echo form_checkbox('remember', '1', FALSE, 'id="remember"');?> | <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#pswreset1">Lupa Password?</button>
						<hr>

  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li <?php if($this->uri->segment(3) == "edit_user"){echo "class='active'";} ?>>
        ...
        <li <?php if($this->uri->segment(2) == "SettingSyc"){echo "class='active'";} ?>>
        <a href='<?php $user_id = $this->session->userdata('user_id'); echo base_url('admin/SettingSyc') ?>'>
          <i class='fa fa-edit'></i><span> Edit Syc </span>
        </a>
      </li>
